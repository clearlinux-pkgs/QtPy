...
Source0  : https://files.pythonhosted.org/packages/a5/aa/661c4ce9bed57ea80e1692ff66bfa27d116cbbf7952362c45ceb0282a7a2/QtPy-1.11.2.tar.gz
...
%prep
%setup -q -n QtPy-1.11.2
cd %{_builddir}/QtPy-1.11.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636414848
...
cp %{_builddir}/QtPy-1.11.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/QtPy/df93926e7bb00976b7e0df5bada6a01580bb3aec
