...
Source0  : https://files.pythonhosted.org/packages/7d/0d/5e2e2a580519d7e7df3840716835f4578bfa434a949d1195fa0661a24503/QtPy-1.11.3.tar.gz
...
%prep
%setup -q -n QtPy-1.11.3
cd %{_builddir}/QtPy-1.11.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638564056
...
cp %{_builddir}/QtPy-1.11.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/QtPy/df93926e7bb00976b7e0df5bada6a01580bb3aec
